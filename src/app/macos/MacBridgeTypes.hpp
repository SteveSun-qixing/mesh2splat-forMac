...
struct MacBridgeUiCommand {
    ...
    float lightPositionX = 3.0f;
    float lightPositionY = 4.0f;
    float lightPositionZ = 2.5f;
    float lightIntensity = 1.0f;
    float lightColorRed = 1.0f;
    float lightColorGreen = 0.95f;
    float lightColorBlue = 0.85f;
